...
export const Sales360Team = {
  ...
  isPrimary: false,
  description1: ["Distributed Sales Force allows an environment for the professional to have the Gig Life"],
  description2: [],
  image: writing.src,
  sections: [
    {
    ...
    },
    {
      ...
      svg: "home",
      content: [
        "The DSF Sales 360 Team is comprised of Business Development Managers (BDs) - professional salespeople, seasoned in making high-level calls into an organization.",
        "Distributed Sales Force's Self Employment Career Opportunity allows for self-employed professionals to work at home.",
        "Many of Distributed Sales Force's Sales 360 Team contractors are women and moms who have chosen a work-at-home lifestyle for a variety of reasons.",
        "Distributed Sales Force creates a collaborative virtual environment using readily available cloud and collaboration tools. In today's On-Demand Economy, Distributed Sales Force allows an environment for the professional to have the Gig Life.",
    ...
    },
    {
      id: "Hero",
      image: team.src,
      title: "Sales 360 Team Benefits",
      content: [
        "As a Business Development Manager (BD) at Distributed Sales Force, we give you all the tools to be in business for yourself as an independent contractor.",
        "With our national reputation, you can have your own lead generation business. We will give you the tools and resources to be successful.",
    ...
    },
    {
      ...
      content: [
        ...
        "Your own vertical market understanding is important to us.",
      ],
      link: "",
      href: "#",
      image: null,
      ...
      data: {
        ...
        col1: [
          [
            ...
            "We do offer hourly pay with a bonus",
          ],
        ],
        col2: [
    ...
    },
    {
      id: "SectionC2TI",
      caption: [],
      title: "Distributed Sales Force's Model for Success",
      svg: "rocket",
      content: [
      ...
      data: [
        {
          ...
          svg: "university",
          content: [
            "Distributed Sales Force is not a self-serve model. You must request an interview and have knowledge of how to drive sales for solution providers. All of our customers sell High-Value Solutions.",
            "Our job is to drive revenue for them. Knowledge of Sales and Marketing in the vendor space is a requirement. Request an Interview and get on the DSF Map.",
          ],
          link: "",
          href: "#",
        },
        {
          ...
          svg: "support",
          content: [
            "Distributed Sales Force offers administrative support for independent contractors.",
            "You can still be self-employed, but allow Distributed Sales Force to support your independent contractor efforts.",
            "We win business and then assign accounts to you. All of the administrative support comes from Distributed Sales Force, you can just do what you do best.",
          ],
          link: "",
          href: "#",
        },
      ...
      data: [
        {
          ...
          content: [
            ...
            "Six figures can be achieved if one tackles all aspects of our program: prospecting, managing, and new account acquisition.",
          ],
          link: "",
          href: "#",
        },
        {
          ...
          svg: "tools",
          content: [
            "DSF gives our Business Development Managers (BDs) the tools to grow their own business.",
            "With our client relationships, we can smooth out your income by allowing you to vie for accounts as they come up.",
            "We are doing your selling to keep your gig pipeline full.",
          ],
          link: "",
          href: "#",
        },
