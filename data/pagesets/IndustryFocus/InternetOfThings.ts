  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "DSF is involved with IoT/M2M manufacturers, M2M developers, M2M integrators, and solution providers.",
    ...
    },
    {
      ...
      svg: null,
      content: [
        "With IoT still being fairly new to the market, DSF finds itself involved in Business Development activity, as well as Sales Channel Development for our customers.",
        "DSF is focused on Sales Planning and Sales Development to push an emerging company to the next level, and maybe to the level of gaining investments, or even a liquidity event.",
        "DSF can represent either the investor making the investment or acquisition, or the company that owns the IP (intellectual property) looking for investors or a liquidity event.",
      ],
      link: "",
      href: "#",
      image: null,
