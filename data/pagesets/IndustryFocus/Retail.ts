...
export const Retail = {
  ...
  sections: [
    ...
    },
    {
      ...
      svg: null,
      content: [
        "DSF offers Sales Prospecting in all facets of Retail:",
        [
          "Point of Sale",
          "Mobile POS",
          "Mobile Payment",
    ...
    },
    {
      ...
      svg: null,
      content: [
        "DSF is actively involved in Retail Sales Development and Retail Sales Prospecting for All Things Retail.",
        [
    ...
    },
    {
      ...
      content: [
        ...
        "Partner with DSF to Stuff your Sales Pipe for Retail Solutions and sales strategies to grow your Retail sales business.",
        "Stuff the Sales Pipe with Revenue Producing Sales Opportunities to raise capital.",
        "All Things Retail - DSF Retail Sales Leads",
      ],
      link: "",
      href: "#",
      image: null,
