...
export const OnDemandEconomy = {
  ...
  sections: [
    ...
    {
      id: "SectionC2TI",
      caption: ["Distributed Sales Force"],
      ...
      content: [
        ...
        "Given the challenges for corporations with finding, hiring, and keeping good people, Distributed Sales Force has embraced the On-Demand movement for you, the Vendor.",
    ...
    },
    {
      ...
      svg: null,
      content: [
        "Distributed Sales Force caters to vendors that need Sales, Sales Leads, Appointments, Traffic, Revenue, and all the Internet Marketing that leads up to that.",
